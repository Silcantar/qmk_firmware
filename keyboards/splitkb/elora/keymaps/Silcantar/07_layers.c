 ...
 */
	[_COLEMAK] = LAYOUT_myr(
		...
		KC_CAPS		, UNDO_X	, CUT_V		, COPY_C	, PASTE_D	, KC_Q		, LALT_TABL	, TD_MOUSE	,	  TD_WINMAN	, RALT_TAB	, KC_Z		, KC_H		, KC_K		, KC_COMMA	, KC_DOT	, KC_RGUI,
											  CK_COPY	, OSM_LCTL	, LSFT_ENT	, SH_SPACE	, TD_NUMERIC,	  TD_FUNC	, KC_BSPC	, OSM_RSFT	, OSM_RCTL	, CK_PASTE	,
 ...
 */
	[_NUMERIC] = LAYOUT_myr(
		...
		KC_TRNS		, KC_BSLS	, KC_TILDE	, TD_CCOMM	, KC_PERCENT, TD_PIPES	,			  KC_TRNS	,	  KC_TRNS	,			  KC_PLUS	, KC_7		, KC_8		, KC_9		, KC_PMNS	, KC_TRNS,
		KC_TRNS		, TD_ANGLES	, TD_BRACKS	, TD_BRACES	, TD_PARENS	, TD_PASCOMM,			  KC_NO		,	  KC_NO		,			  KC_SLSH	, RSFT_4	, RCTL_5	, LALT_6	, RGUI_0	, KC_TRNS,
