 ...
 */
	[_COLEMAK] = LAYOUT_myr(
		...
		LGUI_ESC	, KC_A		, KC_R		, KC_S		, KC_T		, KC_G		,			  KC_NO		,	  KC_NO		,			  KC_M		, KC_N		, KC_E		, KC_I		, KC_O		, COLEMAK,
		KC_CAPS		, KC_X		, KC_V		, KC_C		, KC_D		, TD_QUOTES	, LALT_TABL	, TD_MOUSE	,	  TD_WINMAN	, RALT_TAB	, KC_MINUS	, KC_H		, KC_K		, KC_COMMA	, KC_DOT	, KC_RGUI,
